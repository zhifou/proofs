...
var Proof = /** @class */ (function () {
    ...
    // 验证IPv4是否合法
    Proof.prototype.checkIPv4 = function (value) {
        if (value === void 0) { value = ''; }
    ...
    Proof.prototype.checkQQ = function (value) {
        if (value === void 0) { value = ''; }
        var reg = new RegExp(/^[1-9][0-9]{4,10}$/);
        return reg.test(value);
    };
    // 验证微信号是否合法，6至20位，以字母开头，字母，数字，减号，下划线
    Proof.prototype.checkWX = function (value) {
        if (value === void 0) { value = ''; }
        var reg = new RegExp(/^[a-zA-Z]([-_a-zA-Z0-9]{5,19})+$/);
        return reg.test(value);
    };
    // 验证是否包含中文字符
    Proof.prototype.checkCN = function (value) {
        if (value === void 0) { value = ''; }
        var reg = new RegExp(/[\u4E00-\u9FA5]/);
        return reg.test(value);
    };
    // 验证邮政编码是否合法
    Proof.prototype.checkPostcode = function (value) {
        if (value === void 0) { value = ''; }
        var reg = new RegExp(/^[1-9]\d{5}$/);
        return reg.test(value);
    };
    return Proof;
}());
